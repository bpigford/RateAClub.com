    ...
    <main role="main">
      ...
      <div class="bodyDiv">
                  <div class="comment-background" style="width:45%;margin:auto;padding-top:25px;padding-bottom:25px;">
                    ...
                    <form id="create-form" action="PHP/createUserAccount.php" method="POST">
                      ...
                      <h5>Password*</h5>
                        <p>Password must be 8 characters long and contain a capital, a number and a special character.</p>
                  ...
                  <div class="error-message" id="error-msg" style="display: none;">
                    ...
                    <div class="error-message" id="error-msg4" style="display: none;">
                        <p>No First Name Entered</p>
                    </div>
                    <div class="error-message" id="error-msg5" style="display: none;">
