...
<main role="main">
    <div class="bodyDiv">
                  <div class="comment-background" style="width:45%;margin:auto;padding-top:25px;padding-bottom:25px;">
                                ...
                                <?php
                                  echo '<form action="PHP/updateClub.php" id="editClub-form" method="POST" style="margin-left:10%;margin-right:10%;">';
                                  echo '<h5>* = Required Field</h5>';
                                  echo '<h5>Contact Email*</h5>';
                                  echo '<input class="field" type="text" name="clubEmail" id="clubEmail" value="'.$_POST['email'].'"/>';
                                  echo '<h5>Meeting Time</h5>';
                                  echo '<input class="field" type="text" name="meetTime" value="'.$_POST['time'].'"/>';
                                  echo '<h5>Meeting Location</h5>';
                                  echo '<input class="field" type="text" name="meetLoc" value="'.$_POST['location'].'"/>';
                                  echo '<h5>Club Description*</h5>';
                                  echo '<textarea class="field" type="text" id="clubDesc" name="clubDesc" rows=5>'.$_POST['desc'].'</textarea>';
                                  echo '<h5>Advisor Name</h5>';
                                  echo '<input class="field" type="text" name="advisorName" value="'.$_POST['advisor'].'"/>';
  
                                  echo '<input type="submit" class="button-b"></input>';
