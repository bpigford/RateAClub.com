    ...
    <main role="main">
      ...
      <div class="bodyDiv">
                  <div class="comment-background" style="width:45%;margin:auto;padding-top:25px;padding-bottom:25px;">
                    ...
                    <div class="my-log login-mid-top">
                      <p>New School</p>
                      <select name="newSchool">
                          <?php
                          $getSchoolInfo = "SELECT college_id, college_name FROM Colleges;";
                          $schoolInfoResponse = $dbc->query($getSchoolInfo);
                          if($schoolInfoResponse == false) {
                              echo "failed to get all schools";
                          }
                          while($row = $schoolInfoResponse->fetch_assoc()) {
                              if($row['college_name'] == "School not in Database") {
                    ...
                    <div class="my-log login-mid-mid">
                      <input type="Submit" class="button-b" value="Change Schools" />
                    </div>
                  </form>
                  <div class="my-log login-bottom">
